      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><img class="d-block img-fluid userimg-small" src="serveImage.php?type=photo&userId=<?php echo $user["id"]; ?>"></td>
            <td><img class="d-block img-fluid userimg-small" src="serveImage.php?type=privacy&userId=<?php echo $user["id"]; ?>"></td>
            <td>
              <a class="btn btn-outline-success"><i class="fas fa-check"></i></a>
              <a class="btn btn-outline-danger"><i class="fas fa-times"></i></a>
              <a class="btn btn-outline-danger"><i class="fas fa-times"></i></a>
            </td>
          </tr>
        <?php
